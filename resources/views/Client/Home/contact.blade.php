...
<div class="row">
    <div class="row" style="height: 620px;">
        ...
        <div class="col-5 mt-3" style="text-align: justify">
            ...
            <p>
                Address: 140 Le Trong Tan, Tay Thanh, Tan Phu, Ho Chi Minh
            </p>
            <p>
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <h4>TechKey Support Team will respond to your inquires in 24 hours.</h4>
    </div>
    <div class="row">
        <form action="/home/contact" method="post" style="height: 300px;">
            ...
            <div class="col-3 mt-3">
                <button class="btn btn-dark my-3 text-white" type="submit" style="border-radius: 0;">Submit</button>
            </div>
        </form>
    </div>
</div>
