...
@section('content')
    <div class="row">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-5">
                    <div class="card-body">
                        ...
                        <p class="card-text text-danger" style="font-size: 20px;">
                            {{ number_format($product->price, 0, ',', '.') }} VND</p>
                        <p class="card-text">Bàn Phím Cơ MONSGEEK M1W RGB Mạch Xuôi kết nối 3 chế độ (Nhôm CNC, Gasket
                            Mount)</p>
                        ...
                        <form action="{{ route('cart.add') }}" method="post">
                            ...
                            <button class="btn my-3 text-center" type="submit"
                                style="border-radius: 3px; background-color:gray;   width: 200px; height: 40px; color: white;">@lang('messages.Add to cart')</button>
                            <button class="btn my-3 text-center" type="submit"
                                style="border-radius: 3px; background-color: gray; width: 200px; height: 40px; color: white;">@lang('messages.Buy now')</button>
                        </form>
        ...
        <div class="col-12" style="text-align: justify">
            ...
            <p class="card-text">- Khách hàng chọn option "Mod Full Phím" sẽ chọn switch Cream Yellow hoặc Cream Blue note
                lại giúp shop ở trong phần tin nhắn</p>
            <p class="card-text">
                - Khách hàng chọn option "Mod Full + Sw Bất Kì" sẽ bao gồm các switch (Haze Pink, Piano, Wine Red) và chọn
                switch khách hàng muốn rồi note lại giúp shop ở trong phần tin nhắn
            </p>
            <div class="container my-3">
                <iframe width="700" height="415" src="https://www.youtube.com/embed/iRKeuwFn_m4?si=FWjEOZA5p5QphogP"
        ...
        <div class="col-12 my-4">
            <div class="text-center fs-2 border-top border-bottom">
                Các sản phẩm liên quan
            </div>
        </div>
        <div class="col-12 d-flex f-wrap justify-content-center">
                ...
                <div class="col-3 my-3">
                    <a href="/products/{{ $item->_id }}" class="text-decoration-none text-black">
                        <div class="card"
                            ...
                            <img src="{{ asset('images_upload/' . $item->image) }}" class="card-img-top img-fluid"
                                style="height: 200px; max-width: 100%; object-fit: cover;" alt="">
                            <div class="card-body">
                                ...
                                <div class="mx-auto justify-content-around d-lg-inline d-none">
                                    <form action="#" method="post">
                                        <a href="/products/{{ $item->_id }}" class="btn btn-dark my-3"
