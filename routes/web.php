...
Route::middleware(EnsureCartIsAccessedByAuthenticatedUser::class)->group(function () {
    ...
    Route::prefix('/cart')->group(function(){
        ...
        Route::post('/add', [CartsController::class, 'add'])->name('cart.add');
        Route::post('/remove', [CartsController::class, 'remove'])->name('cart.remove');
        Route::post('/update-quantity', [CartsController::class, 'updateQuantity'])->name('cart.updateQuantity');
    });
